...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ref_audio", type=str, default="./samples/petra.wav", help="Path to reference audio file"
    )
    parser.add_argument(
        "--ref_text",
        type=str,
        default="./samples/petra.txt",
        help="Reference text corresponding to the reference audio",
    )
    parser.add_argument(
        "--output_path",
        type=str,
        default="output_petra.wav",
        help="Path to save the output audio",
    )
    parser.add_argument(
        "--backbone",
        type=str,
        default="/home/psimandan/Desktop/neutts-main/data/neutts-romanian-finetune/checkpoint-370000",
